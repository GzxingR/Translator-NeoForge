...
无 ModMenu 时仍可通过 **U 键** 或 `/transconfig config` 打开配置。
...
- [INSTALL_zh.md](INSTALL_zh.md) — 安装与指令
- [TEST_zh.md](TEST_zh.md) — 测试指南
- [MAINTAIN_zh.md](MAINTAIN_zh.md) — 维护指南
