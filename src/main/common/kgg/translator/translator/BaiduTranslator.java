...
public abstract class BaiduTranslator extends Translator {
    ...
    @Override
    protected synchronized String translate(String Component, String from, String to) throws IOException {
        return delay(delayTime, () -> {
            ...
            Map<String, Object> params = Map.of(
                    ...
                    "appid", appId,
                    "salt", salt,
                    "sign", Hashing.md5().hashString(appId + Component + salt + appKey, StandardCharsets.UTF_8).toString()
            );
            // 请求
